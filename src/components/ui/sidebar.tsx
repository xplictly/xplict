...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-full px-4 py-4 hidden md:flex md:flex-col bg-sidebar w-[300px] flex-shrink-0 border-r border-border",
        className
      )}
      animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-16 px-4 py-4 flex flex-row md:hidden items-center justify-between bg-sidebar w-full border-b border-border"
        )}
        {...props}
      >
